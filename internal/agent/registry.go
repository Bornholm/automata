...
func NewRegistry(cfg *config.Config, mcpManager *mcp.Manager) (*Registry, error) {
	return NewRegistryWithMemory(cfg, MemoryTools{}, ReminderTools{}, ProfileTools{}, mcpManager, nil, nil)
}
...
func NewRegistryWithMemory(cfg *config.Config, memoryTools MemoryTools, reminderTools ReminderTools, profileTools ProfileTools, mcpManager *mcp.Manager, metrics *observability.Metrics, logger *slog.Logger) (*Registry, error) {
