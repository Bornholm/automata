...
func TestMCPToolAgent_SimpleSearch(t *testing.T) {
	...
	a := agent.NewMCPToolAgent(client, "system", "research", cfg, m, []string{"internet-search"}, mcp.Limits{}, 5)
...
func TestMCPToolAgent_TruncatedResultStillCompletesTurn(t *testing.T) {
	...
	a := agent.NewMCPToolAgent(client, "system", "research", cfg, m, []string{"internet-search"}, mcp.Limits{MaxToolResultBytes: 40}, 5)
...
func TestMCPToolAgent_MaxToolCallsReached(t *testing.T) {
	...
	a := agent.NewMCPToolAgent(client, "system", "research", cfg, m, []string{"internet-search"}, mcp.Limits{}, maxSequentialToolCalls)
